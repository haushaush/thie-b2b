    ...
    <div className="max-w-3xl mx-auto pb-12">
      ...
      <div className="prose prose-sm dark:prose-invert max-w-none space-y-8">
        ...
        <section>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <h4 className="font-medium mt-3 mb-1">Wer ist verantwortlich für die Datenerfassung auf dieser Website?</h4>
              <p className="text-muted-foreground">
                Die Datenverarbeitung auf dieser Website erfolgt durch den Websitebetreiber. Dessen Kontaktdaten können Sie dem Abschnitt „Hinweis zur Verantwortlichen Stelle" in dieser Datenschutzerklärung entnehmen.
              </p>

              <h4 className="font-medium mt-3 mb-1">Wie erfassen wir Ihre Daten?</h4>
              <p className="text-muted-foreground">
                Ihre Daten werden zum einen dadurch erhoben, dass Sie uns diese mitteilen. Hierbei kann es sich z. B. um Daten handeln, die Sie in ein Kontaktformular eingeben. Andere Daten werden automatisch oder nach Ihrer Einwilligung beim Besuch der Website durch unsere IT-Systeme erfasst. Das sind vor allem technische Daten (z. B. Internetbrowser, Betriebssystem oder Uhrzeit des Seitenaufrufs). Die Erfassung dieser Daten erfolgt automatisch, sobald Sie diese Website betreten.
              </p>

              <h4 className="font-medium mt-3 mb-1">Wofür nutzen wir Ihre Daten?</h4>
              <p className="text-muted-foreground">
                Ein Teil der Daten wird erhoben, um eine fehlerfreie Bereitstellung der Website zu gewährleisten. Andere Daten können zur Analyse Ihres Nutzerverhaltens verwendet werden.
              </p>

              <h4 className="font-medium mt-3 mb-1">Welche Rechte haben Sie bezüglich Ihrer Daten?</h4>
              <p className="text-muted-foreground">
            ...
            <div>
              <h3 className="text-lg font-semibold mb-2">Analyse-Tools und Tools von Drittanbietern</h3>
              <p className="text-muted-foreground">
        ...
        <section>
          ...
          <p className="text-muted-foreground mb-4">Wir hosten die Inhalte unserer Website bei folgenden Anbietern:</p>
          
          <div className="space-y-4">
            <div>
              <h3 className="text-lg font-semibold mb-2">IONOS</h3>
              <p className="text-muted-foreground">
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-2">
                Details entnehmen Sie der Datenschutzerklärung von Webflow: <a href="https://webflow.com/legal/eu-privacy-policy" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">https://webflow.com/legal/eu-privacy-policy</a>. Die Verwendung von Webflow erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Wir haben ein berechtigtes Interesse an einer möglichst zuverlässigen Darstellung unserer Website. Sofern eine entsprechende Einwilligung abgefragt wurde, erfolgt die Verarbeitung ausschließlich auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TTDSG, soweit die Einwilligung die Speicherung von Cookies oder den Zugriff auf Informationen im Endgerät des Nutzers (z. B. Device-Fingerprinting) im Sinne des TTDSG umfasst. Die Einwilligung ist jederzeit widerrufbar. Die Datenübertragung in die USA wird auf die Standardvertragsklauseln der EU-Kommission gestützt. Details finden Sie hier: <a href="https://webflow.com/legal/eu-privacy-policy" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">https://webflow.com/legal/eu-privacy-policy</a>.
              </p>
            </div>
        ...
        <section>
          ...
          <div className="space-y-4">
            ...
            <div>
              <h3 className="text-lg font-semibold mb-2">Allgemeine Hinweise zu den Rechtsgrundlagen der Datenverarbeitung auf dieser Website</h3>
              <p className="text-muted-foreground">
            ...
            <div>
              <h3 className="text-lg font-semibold mb-2">Hinweis zur Datenweitergabe in die USA und sonstige Drittstaaten</h3>
              <p className="text-muted-foreground">
            ...
            <div>
              <h3 className="text-lg font-semibold mb-2">Widerspruchsrecht gegen die Datenerhebung in besonderen Fällen sowie gegen Direktwerbung (Art. 21 DSGVO)</h3>
              <div className="bg-muted/50 rounded-lg p-4 text-sm text-muted-foreground">
                <p className="uppercase font-medium text-foreground mb-2">
            ...
            <div>
              <h3 className="text-lg font-semibold mb-2">Recht auf Datenübertragbarkeit</h3>
              <p className="text-muted-foreground">
            ...
            <div>
              <h3 className="text-lg font-semibold mb-2">Auskunft, Berichtigung und Löschung</h3>
              <p className="text-muted-foreground">
            ...
            <div>
              <h3 className="text-lg font-semibold mb-2">Recht auf Einschränkung der Verarbeitung</h3>
              <p className="text-muted-foreground">
                Sie haben das Recht, die Einschränkung der Verarbeitung Ihrer personenbezogenen Daten zu verlangen. Hierzu können Sie sich jederzeit an uns wenden. Das Recht auf Einschränkung der Verarbeitung besteht in folgenden Fällen:
              </p>
              <ul className="text-muted-foreground list-disc list-inside mt-2 space-y-2">
        ...
        <section>
          ...
          <div className="space-y-4">
            ...
            <div>
              <h3 className="text-lg font-semibold mb-2">Anfrage per E-Mail, Telefon oder Telefax</h3>
              <p className="text-muted-foreground">
